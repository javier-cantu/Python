...
This document outlines the purpose and execution flow of the three-script pipeline used to convert raw, structured text into a validated EPUB 3 file ready for platforms like Google Play Books.

### 1. Overview of the Pipeline

The process takes content from a single, structured source file (raw_content.txt) and transforms it through three distinct stages to produce a correctly formatted and packaged EPUB file.
...
* **Fragment Logic (Traditional):** It treats **Level 1** and **Level 2** markers as **new file boundaries**. All content (Level 3+ headings, images, and paragraphs) falling between two L1/L2 markers is grouped into a **single XHTML file**.
...
* **Output:**
    ...
    * **Images/cover.jpg**.
    * **epub_parts/toc_data.json**: A necessary JSON file that maps the section hierarchy (L1, L2, L3) to the generated filenames for use by Script 03.
