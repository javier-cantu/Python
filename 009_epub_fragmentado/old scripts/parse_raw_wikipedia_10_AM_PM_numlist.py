...
#   - **Nuevo: Manejo de puntos en listas numeradas (ej. "1. Item") para evitar divisiones.**
...
# - El éxito de la protección de abreviaturas depende de la lista predefinida; es posible que se necesiten añadir más.
#
# 🛠 Cómo extender:
# - Agrega más abreviaciones o títulos a las listas `abbreviations` o `titles` según sea necesario.
...
for line in raw_lines:
    ...
    # --- Párrafos normales ---
        ...
        # Busca un número seguido de un punto y un espacio al principio de una línea (con opcionalmente espacios al inicio).
        # Lo reemplaza con el número y un placeholder para el punto.
        line = re.sub(r'^\s*(\d+)\.\s*', r'\1__NUMDOT__ ', line)

        # PASO 1: Normalizar patrones de puntos suspensivos *antes* de protegerlos.
        # Esto es CRUCIAL para evitar el "punto extra" y las divisiones no deseadas.
        ...
        # PASO 2: Proteger abreviaciones y títulos.
        # Estas deben ser protegidas *antes* de los puntos suspensivos para evitar conflictos.
        ...
        abbreviations = {
            ...
            "P.M.": "P__DOT__M__DOT__", # Añadido P.M.
            "A.M.": "A__DOT__M__DOT__"  # Añadido A.M.
        }
        ...
        # (tu lógica original con [ELLIPSIS] que funciona una vez normalizado el input)
        ...
        # Este splitter ahora funcionará de manera más fiable porque los puntos problemáticos
        # y las abreviaciones están protegidos.
        sentences = re.split(r'(?<=[.!?])\s+', line)

        # PASO 4: Restaurar abreviaciones, títulos y los puntos suspensivos.
        restored_sentences = []
        for s in sentences:
            ...
            # NUEVO: Restaurar puntos en números de lista
            s = re.sub(r'(\d+)__NUMDOT__\s*', r'\1. ', s) # Asegura que se restaure con el formato "1. "
