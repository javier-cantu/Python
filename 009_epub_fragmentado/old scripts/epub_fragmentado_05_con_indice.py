...
file_prefix = "Wikipedia_Philosophy"
start_index = 1
...
for line in content_lines:
    if line.startswith("[") and line.endswith("]"):
        ...
        html_heading = f"<h{tag}>{current_title}</h{tag}>"
...
# === Write index.xhtml as nested TOC ===
...
print("✅ XHTML files generated with corrected titles and clean TOC.")
